...
public class LimeFile
{
    ...
    /// <param name="aesEncryptionPlatform">The AES encryption platform used to perform the decryption of segments.</param>
    ...
    public async Task DecryptSegmentsAsync(ulong userId, AesEncryptionPlatform aesEncryptionPlatform, ParallelOptions? po = null)
    {
        await DecryptDataAsync(Segments, userId, aesEncryptionPlatform, po);
        IsEncrypted = false;
    }
    ...
    /// <param name="aesEncryptionPlatform">The AES encryption platform used to perform the encryption of the segments.</param>
    ...
    public async Task EncryptSegmentsAsync(ulong userId, AesEncryptionPlatform aesEncryptionPlatform, ParallelOptions? po = null)
    {
        await EncryptDataAsync(Segments, userId, aesEncryptionPlatform, po);
        IsEncrypted = true;
    }
